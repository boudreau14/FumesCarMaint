...
function Main() {
    return (
        <div>
            <Hero backgroundImage="https://images.unsplash.com/photo-1504222490345-c075b6008014?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80">
        <h1>Car App</h1>
        <h2>Taking the Wrench Out of Repairs</h2>
      </Hero>
